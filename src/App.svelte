...
<style>
  ...
  .skill-list li { padding: 0.5rem 0; padding-left: 1.5rem; position: relative; }
  .skill-list li:before { content: "Right Arrow"; position: absolute; left: 0; color: #00ffff; }
  ...
  .contact-item { display: flex; align-items: center; gap: 1rem; padding: 1rem; background: rgba(0,255,255,0.05); border: 1px solid #00ffff; border-radius: 5px; }
